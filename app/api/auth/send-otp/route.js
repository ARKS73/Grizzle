...
export async function POST(request) {
  try {
    ...
    // Send real Email via Nodemailer using Gmail SMTP credentials
    const smtpUser = process.env.SMTP_USER || 'sridepp555555@gmail.com';
    const smtpPass = process.env.SMTP_PASS || 'wowx bknm dfdm orox';
    ...
    if (smtpUser && smtpPass) {
      try {
        ...
        console.error('Nodemailer SMTP Error:', emailErr);
      }
    }
